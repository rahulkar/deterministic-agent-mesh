...
mvn compile exec:java "-Dagentmesh.adk.start-runtime-on-load=true" "-Dagentmesh.adk.fixed-agent-ports=true" "-Dexec.mainClass=com.google.adk.web.AdkWebServer" "-Dexec.args=--adk.agents.source-dir=. --server.port=%SERVER_PORT%"
